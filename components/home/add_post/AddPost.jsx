...
const AddPost = () => {
  ...
  return (
    <>
      <BlurContainer
        cln="w-full h-[8rem] lg:h-auto lg:min-h-[10rem] mt-[2rem] round p-[2.2rem] raise add-post-container transition-all hover:translate-y-[-0.5rem]"
      ...
      >
        <button className="w-full h-full round">
          <div className="!w-full !h-full ml-[-1rem] lg:pl-[1rem] pr-[2rem] flex items-center justify-between text-gray font-semibold round">
            <div className="flex items-center gap-[1rem]">
              <SmallProfileImage img="/images/wepik-export-20231128203407BKL1.jpeg" />
              <span className="lg:text-[2rem] text-[1.5rem] kalinia-font">
                Start a post
              </span>
            </div>
          </div>
